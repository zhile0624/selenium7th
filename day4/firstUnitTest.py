...
# 因为unittest比selenium更常用,几乎所有测试都要要用unittest组织测试
# 所有python把unittest集成在python SDK中了, 不需要单独下载,只要安装python就有,unittest是python内置的代码库
import unittest
